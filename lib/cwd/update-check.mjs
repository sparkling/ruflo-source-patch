...
export function currentVersion() {
  const sourceLib = syncedFrom();
  const roots = [
    // stable.mjs records the mirrored `lib/` directory, not the package root.
    sourceLib ? path.dirname(sourceLib) : null,
    // When this module runs from a package/clone rather than the stable copy, package.json is two
    // directories above lib/cwd/. fileURLToPath keeps spaces and non-ASCII paths correct.
