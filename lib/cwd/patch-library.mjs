    ...
    edits: [
      {
        ...
        replace: "        if (true) // ruflo-source-patch(init): `skills add ruvnet/ruflo --skill ruflo` lands the WHOLE repo in .agents/skills/ruflo (97MB, 384 SKILL.md vs 4 real skills) and blows the host agent's skills context budget; the installed plugins already provide these skills (#2640)\n            return;\n        if (ctx.flags['no-skills-sh'] === true)\n            return;",
      },
    ],
  },
];
