...
try {
  ...
  bridgeRegistryMap: {
    deps: ['req'],
    src: `const __RSP_MEMORY_BRIDGE_PATHS_REVISION = "2026-08-31.1";
...
export const ENTRIES = [
  ...
  },
  {
    ...
    proof: 'const __RSP_MEMORY_BRIDGE_PATHS_REVISION = "2026-08-31.1";',
    edits: [
      {
    ...
    if (!state.promise) {
      ...
      },
      {
        find: `            catch {
                ...
                return null;`,
        replace: `            catch {
                __rufloSetBridgeFailure(dbPath, 'ControllerRegistry initialization failed');
                state.available = false;
                state.promise = null;
                return null;`,
      },
