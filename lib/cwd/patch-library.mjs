...
export const TARGET_INFO = {
  ...
  'plugin-hosts': 'dual-host Ruflo marketplace install/uninstall + additive Claude-to-Codex reconciliation (#2854)',
};
...
export const ENTRIES = [
  ...
  // plugin CLI; do not rewrite either host's cache or overload the IPFS/npm installer.
  {
    ...
    edits: [
      {
        ...
        replace: '    subcommands: [listCommand, searchCommand, installCommand, uninstallCommand, upgradeCommand, toggleCommand, infoCommand, createCommand, rateCommand, __rspHostInstallCommand, __rspHostUninstallCommand, __rspHostSyncCommand],',
      },
      {
