...
export const PATCH_TARGETS = ['cwd', 'daemon', 'memory', 'state'];
...
export const TARGET_INFO = {
  ...
  state: 'durable state stops following a drifted cwd — autopilot/neural/metrics/agentdb silently reset without this (#2633)',
};
