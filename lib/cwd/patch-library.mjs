...
export const PATCH_TARGETS = ['cwd', 'daemon', 'memory', 'init', 'plugin-hosts', 'ruflo-model-contract', 'ruflo-learning-stats', 'ruflo-memory-stats', 'ruflo-graph-persistence', 'ruflo-context-contract'];
