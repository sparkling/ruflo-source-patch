...
import { GRAPH_ENTRIES } from '../ruflo-graph-persistence/patcher.mjs';
import { GRAPH_RETRIEVAL_ENTRIES } from '../ruflo-graph-retrieval/patcher.mjs';
import { CONTEXT_ENTRIES } from '../ruflo-context-contract/patcher.mjs';

const MARKER = PATCH_MARKER;

export const PATCH_TARGETS = ['cwd', 'daemon', 'memory', 'init', 'plugin-hosts', 'ruflo-model-contract', 'ruflo-learning-stats', 'ruflo-memory-stats', 'ruflo-graph-persistence', 'ruflo-graph-retrieval', 'ruflo-context-contract'];

export const TARGET_INFO = {
  'ruflo-graph-retrieval': 'retained SQL k-hop authority; explicit depth/limit and source failure (#3315/#3202)',
  'ruflo-graph-persistence': 'persistent native graph options; explicit open/lock failures, no volatile substitution (#3313)',
