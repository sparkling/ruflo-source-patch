...
// Updating a script does not update an already-running Node process. The old launcher nevertheless
// accepted any branded `/` response as current, so a detached pre-update router could serve new UI
