...
export const SCRIPT_TARGETS = {
  'dual-codex-claude': {
    ...
    // `codex-skills` ships alongside `templates`: without it in this list the manifests exist
    // in-repo but never reach ~/.ruflo-source-patch, so step 2c silently writes nothing on an
    // installed copy — working from the repo and broken everywhere else.
    dirs: ['templates', 'codex-skills'],
