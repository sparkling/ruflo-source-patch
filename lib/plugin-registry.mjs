...
export const PLUGIN_INFO = {
  ...
  'ruflo-instruction-contract': 'makes generated Claude/Codex instructions use live structured Ruflo interfaces first (#3153)',
};
