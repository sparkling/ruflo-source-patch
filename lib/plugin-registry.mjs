...
export const PLUGIN_TARGETS = ['ruflo-wrapper-guard', 'adr-template', 'adr-index', 'adr-io-safety', 'adr-reindex', 'verify-interface', 'ruflo-hooks-schema', 'mcp-prefix', 'design-wall', 'flywheel-daily', 'codex-hooks', 'ruflo-codex-skills', 'brain-codex-skills', 'brain-console-lifecycle', 'brain-console-provider-keys', 'brain-release-lockstep', 'brain-memory-doctor-roots', 'brain-managed-memory-boundary', 'brain-search-safety', 'brain-dual-host-receipt', 'brain-dual-host-stdin', 'brain-grounding-evidence', 'metaharness-codex-hooks', 'ruflo-instruction-contract'];

export const PLUGIN_INFO = {
  'ruflo-wrapper-guard': 'restores ruflo with the newest installed stable CLI and truthful runtime version (#3306)',
  ...
  'codex-hooks': "legacy Brain lifecycle packaging; retires on native hooks or their explicit withdrawal (#52)",
  ...
  'brain-dual-host-stdin': 'streams large dual-host prompts over stdin instead of one E2BIG-prone argv element (#273)',
  'brain-grounding-evidence': 'records successful Brain searches independently of product-specific write stamps (#316)',
