...
export const PLUGIN_TARGETS = ['adr-template', 'adr-index', 'adr-reindex', 'verify-interface', 'ruflo-hooks-schema', 'mcp-prefix', 'design-wall', 'flywheel-daily', 'codex-hooks', 'ruflo-codex-skills', 'brain-codex-skills', 'brain-console-lifecycle', 'brain-console-provider-keys', 'brain-release-lockstep', 'brain-memory-doctor-roots'];
...
export const PLUGIN_INFO = {
  ...
  'brain-codex-skills': 'repairs Brain whats-new release-note lookup in its active Codex cache (stuinfla/ruvnet-brain#76)',
  'brain-console-lifecycle': 'rejects stale detached Console generations without touching Brain updates (stuinfla/ruvnet-brain#79)',
  'brain-console-provider-keys': 'keeps packaged-catalog failure from masquerading as absent provider keys (stuinfla/ruvnet-brain#86)',
  ...
  'brain-memory-doctor-roots': 'makes the standalone AgentDB fleet scan cover common/configured project roots (stuinfla/ruvnet-brain#81)',
};
