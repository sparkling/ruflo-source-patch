...
export const PLUGIN_TARGETS = ['adr-template', 'adr-index', 'adr-reindex', 'verify-interface', 'ruflo-hooks-schema', 'mcp-prefix', 'design-wall', 'flywheel-daily', 'codex-hooks', 'ruflo-codex-skills', 'brain-codex-skills', 'brain-console-lifecycle', 'brain-release-lockstep', 'brain-memory-doctor-roots'];
