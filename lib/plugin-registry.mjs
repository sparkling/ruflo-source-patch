...
export const PLUGIN_TARGETS = ['adr-template', 'adr-index', 'adr-reindex', 'verify-interface', 'ruflo-hooks-schema', 'mcp-prefix', 'design-wall', 'flywheel-daily', 'codex-hooks'];
...
export const PLUGIN_INFO = {
  ...
  // Ruflo's canonical hook manifest is valid to Claude but not Codex: underscore-prefixed
  // documentation keys make Codex reject all seven handlers before any can load.
  'ruflo-hooks-schema': "makes ruflo-core's hook manifest valid under Codex's strict schema (#2801 / PR #2800)",
