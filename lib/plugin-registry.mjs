...
export const PLUGIN_TARGETS = ['adr-template', 'adr-index', 'adr-reindex', 'verify-interface'];
...
export const PLUGIN_INFO = {
  ...
  'adr-reindex': 'adds the /adr-reindex skill — reconciles the deletions upsert can never reap',
