...
export const PLUGIN_TARGETS = ['adr-template', 'adr-index', 'adr-reindex', 'verify-interface', 'ruflo-hooks-schema', 'mcp-prefix', 'design-wall', 'flywheel-daily', 'codex-hooks', 'ruflo-codex-skills', 'brain-codex-skills'];
...
export const PLUGIN_INFO = {
  ...
  'ruflo-hooks-schema': "makes ruflo-core's manifest and PreToolUse output valid under Codex (PR #2800 / #2816)",
  ...
  'codex-hooks': "adds ruvnet-brain's missing user-global Codex lifecycle plugin (stuinfla/ruvnet-brain#52)",
  'ruflo-codex-skills': 'adds the missing Ruflo status skill to its active Codex cache (ruvnet/ruflo#2821)',
  'brain-codex-skills': 'restores Brain command parity in its active Codex cache (stuinfla/ruvnet-brain#56)',
};
...
export function applyPlugins(targets = []) {
  ...
  // Also additive, but in a different plugin: Codex lifecycle packaging that upstream Brain does not
  // yet ship. It owns no pristine backup and must never overwrite a future upstream manifest.
