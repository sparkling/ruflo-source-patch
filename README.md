...
| [Brain #77](https://github.com/stuinfla/ruvnet-brain/issues/77) | **Open.** The active package/Stable Spine/Claude/Codex report 4.0.12 while the installed KB and public stable release lineage still report 4.0.7; durable two-phase release evidence remains incomplete | Keep `brain-release-lockstep` as a read-only fail-closed reporting guard; never relabel or copy Brain assets downstream |
